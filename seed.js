    ...
    products: [
      {
        ...
        imageUrl: 'https://maxpull-gdvuch3veo.netdna-ssl.com/wp-content/uploads/2010/01/jade-plants1.jpg',
        price: 9.99,
        inventory: 100
      },
      {
        ...
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Prickly_Pear_Closeup.jpg/220px-Prickly_Pear_Closeup.jpg',
        price: 25.00,
        inventory: 16
      }
    ]
    ...
    products: [
      {
        ...
        imageUrl: 'http://www.tropical-plants-flowers-and-decor.com/images/vanorc.jpg',
        price: 30.00,
        inventory: 30
      },
      {
        ...
        imageUrl: 'https://s-media-cache-ak0.pinimg.com/736x/cc/cf/ec/cccfec02f5f027e0b6e2f4a895e8c304--monkey-orchid-rare-flowers.jpg',
        price: 40.00,
        inventory: 12
      }
    ]
...
.then(function () {
  ...
  return Promise.all(categories.map(category => {
    Category.create({name: category.name, imageUrl: category.imageUrl, products: category.products}, {include: [Product]})
  }))
})
